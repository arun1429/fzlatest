...
class Search extends Component {
  ...
  insertAds = data => {
    ...
    this.setState({result: true, isLoading: false, value: this.state.value, data: originalData, status: '200'});
  };
              ...
              <View animation={'slideInRight'} style={styles.mainContainer}>
                <View style={styles.searchContainer}>
                  <Item style={styles.searchView}>
                    ...
                    {!isLoading && <Icon type="AntDesign" name="search1" style={{fontSize: 23, color: COLORS.white}} />}
                  </Item>
                </View>
              ...
              <View animation={'slideInRight'} style={styles.resultContainer}>
                ...
                {!result && !isLoading && status == '' && isConnected && (
                  <View style={styles.noResultContainer}>
                    <FastImage style={styles.notFoundImage} source={require('../../../assets/img/search/search1.png')} resizeMode={FastImage.resizeMode.contain} />
                  </View>
                )}
                ...
                {result && !isLoading && isConnected && (
                  <View style={styles.foundResultContainer}>
                    ...
                    <Viewport.Tracker><FlatList data={formatData(data, numColumns)} style={{height: '100%'}} renderItem={this.renderItem} numColumns={numColumns} /></Viewport.Tracker>
                  </View>
                )}
              </View>
            </ScrollView>
